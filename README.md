...
|----------|---------------------|
| SIEM | Elastic Stack (ELK), Kibana |
| Network Analysis | Wireshark, tcpdump |
| Windows Security | Sysmon, Event Viewer, PowerShell |
| Linux | Ubuntu, Kali Linux, Bash |
| Frameworks | MITRE ATT&CK, Cyber Kill Chain |
| IT Support | Active Directory, M365, Windows Server |
---
